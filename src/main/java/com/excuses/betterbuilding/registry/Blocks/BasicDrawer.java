...
public class BasicDrawer extends BlockWithEntity {

    public BasicDrawer(Settings settings) {
        super(settings);
    }
    ...
    public BlockEntity createBlockEntity(BlockView blockView) {
        ...
        return new BasicDrawerBlockEntity();
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof BasicDrawerBlockEntity) {
                ItemScatterer.spawn(world, pos, (BasicDrawerBlockEntity)blockEntity);
                // update comparators
